...
function handleLogin() {
  if (cpf.value && password.value) {
    console.log('Login com:', cpf.value)
    // Simula a autenticação e guarda um "token"
    localStorage.setItem('user-token', 'seu-token-jwt-aqui');
    // Usa o router para navegar para a página de requisições
...
function handleCreateAccount() {
  // Usa o router para navegar para a página de cadastro
