...
watch([password, confirmPassword], () => { passwordError.value = ''; });
...
async function handleCadastro() {
  ...
  try {
    ...
    errorMessage.value = error.message || 'Ocorreu um erro ao tentar registar.';
  } finally {
...
<style scoped>
/* Os estilos permanecem os mesmos, com a adição do estilo de erro genérico */
